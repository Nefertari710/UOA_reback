...
while not Flag_Done:
    sum += 1
    # if str(pai_list[1:origin + 1]) == "[2, 5, 1, 3, 4]":
    #     break
    ...
    if A_list:                                  # judge A_list is empty or not?
        ...
        pai_ni_list[m] = pai_ni_list[m] + direction_list[m]  # pai_ni_list represent current element place such as 
